...
//  COMPLETED (6) Write a method called buildUriMatcher where you match URI's to their numeric ID
    ...
    public UriMatcher buildUriMatcher(){
      final  UriMatcher  uriMatcher1 = new UriMatcher(UriMatcher.NO_MATCH);
       uriMatcher1.addURI(WeatherContract.CONTENT_AUTHORITY,WeatherContract.PATH_WEATHER,CODE_WEATHER);
       uriMatcher1.addURI(WeatherContract.CONTENT_AUTHORITY,WeatherContract.PATH_WEATHER+"/#",CODE_WEATHER_WITH_DATE);
